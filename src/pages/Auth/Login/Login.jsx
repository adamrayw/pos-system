...
const Login = () => {
    ...
    return (
        <div className="md:px-12 px-4 py-10 md:p-10 ">
            <div className="flex flex-col w-full max-w-md mx-auto mt-8 px-4 py-8 bg-white rounded-lg shadow sm:px-6 md:px-8 lg:px-10">
                ...
                <div className="flex items-center justify-center mt-6">
                    <Link to="/" className="inline-flex items-center tracking-wide text-sm font-normal text-center text-gray-500 hover:text-gray-700 ">
                        <span className="ml-2">
                            Belum berlangganan?
                        </span>
                    </Link>
