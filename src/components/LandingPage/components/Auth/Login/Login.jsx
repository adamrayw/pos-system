            ...
            <label htmlFor="modal-login" className="modal cursor-pointer">
                <label className="modal-box relative max-w-sm flex flex-col justify-center" htmlFor="">
                    <div className="flex justify-between items-center mb-2">
                        <h3 className="text-xl font-bold">Login Akun <span className='text-blue-500'>POSKU</span></h3>
                    ...
                    <form action="" className='space-y-2' onSubmit={handleLogin}>
                        ...
                        <div className='flex justify-end space-x-2'>
                            <div className="modal-action">
                                <label htmlFor="modal-login" className="btn btn-md text-xs btn-outline hover:bg-blue-500 border border-s-blue-500 text-blue-500">Batal</label>
                            </div>
                            <div className="modal-action">
                                {isLoading ?
                                    (
                                        <button className="btn bg-blue-200 text-blue-500 loading border-0" >Sedang Login</button>
                                    ) : (
                                        <button type='submit' className="btn text-xs bg-blue-500 border-0 hover:bg-blue-600">Login</button>
                                    )}
                            </div>
                        </div>
                    </form>
